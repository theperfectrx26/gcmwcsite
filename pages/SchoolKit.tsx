          ...
          <div className="bg-white border border-beige p-8 md:p-12 shadow-sm rounded-sm">
            {submitted ? (
              <div className="text-center py-10">
                ...
                <a 
                  href="/downloads/gcmwc-institutional-partnership-kit.pdf" 
                  ...
                  download="gcmwc-institutional-partnership-kit.pdf"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <h3 className="text-xl font-bold text-navy uppercase tracking-widest mb-6 italic">Download Official Kit</h3>
