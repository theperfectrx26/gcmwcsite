      ...
      <header className="relative py-20 bg-beige overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold text-navy mb-6 italic uppercase tracking-tight">
            Institutional Standards Adoption
          </h1>
          <p className="max-w-3xl text-xl leading-relaxed text-navy/80 font-medium italic mb-8">
            Institutions and university partners may adopt GCMWC standards to align their internal programs with global non-clinical coaching pathways. 
            Adoption focuses on safety, ethical consistency, and professional protection.
          </p>
        </div>
      </header>
      ...
      <section className="py-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        ...
        <div className="bg-white border border-beige p-8 md:p-12 shadow-sm rounded-sm">
          <div className="flex items-center space-x-4 mb-6">
            ...
            <h2 className="text-2xl font-bold text-navy uppercase tracking-widest">Global Standards Alignment</h2>
          </div>
          <p className="text-navy/70 leading-relaxed italic max-w-4xl">
            Aligning institutional programs with GCMWC standards ensures that curriculum, assessment, and delivery meet the high-integrity benchmarks required for professional wellness coaching. 
            Partners must demonstrate a rigorous commitment to non-clinical scope boundaries and clear referral protocols within their training environments.
          </p>
        </div>
