...
const MWFR: React.FC = () => {
  return (
    <div className="bg-white min-h-screen">
          ...
          <div>
            ...
            <div className="grid grid-cols-2 gap-8 mb-12">
              ...
              <div className="bg-beige/40 p-6 border border-navy/5">
                ...
                <p className="text-lg font-bold text-navy italic">$100</p>
              </div>
            </div>
      ...
      {/* Disclaimer */}
      <section className="py-20 bg-white border-t border-beige text-center">
        <div className="max-w-4xl mx-auto px-4 inline-block text-left text-navy/80 italic text-sm leading-relaxed border-l-4 border-navy p-8 bg-beige/40 shadow-sm">
