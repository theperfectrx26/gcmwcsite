      ...
      <section className="max-w-6xl mx-auto px-4 py-20 space-y-16">
        ...
        <div className="rounded-sm border border-beige bg-white p-10 shadow-sm">
          ...
          <div className="grid gap-4 md:grid-cols-3">
            {[
              ["Weeks 1–3", "Foundations and scope", "Orientation, non-clinical boundaries, ethics, and mandatory discussions."],
              ["Weeks 4–6", "Skills & Evaluation", "Core coaching tools, peer labs, and midterm competency evaluation."],
              ["Weeks 7–8", "Applied practice", "Advanced modules, final prep, and live practical examination scheduling."],
              ["Weeks 9–10", "Completion window", "Final examinations and program term closure. Week 10 is the absolute cutoff."],
